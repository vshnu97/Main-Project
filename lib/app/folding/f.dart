          ...
          children: <Widget>[
            FoldCard(
              ...
              frontWidget: _buildFrontWidget(_foldcardKey1, " Flutter Course ",
                  const Color.fromARGB(255, 70, 132, 255)),
              innerWidget: _buildInnerWidget(
                  _foldcardKey1,
                  "DM \"Flutter\" for mentorship",
                  "Limited only",
                  "assests/carpentr.jpg",
                  const Color.fromARGB(255, 133, 194, 255),
            ...
            FoldCard(
              ...
              innerWidget: _buildInnerWidget(
                  ...
                  const Color.fromARGB(255, 118, 63, 255),
                  const Color.fromARGB(242, 192, 167, 255)),
            ...
            FoldCard(
              ...
              frontWidget: _buildFrontWidget(
                _foldcardKey3,
                "Do Share & Comment",
                const Color.fromARGB(255, 42, 158, 187),
              ),
              innerWidget: _buildInnerWidget(
                  _foldcardKey3,
                  "",
                  ...
                  const Color.fromARGB(255, 102, 166, 182),
                  const Color.fromARGB(255, 42, 158, 187)),
              cardSize: Size(MediaQuery.of(context).size.width, 140),
              padding: const EdgeInsets.all(15),
              animationDuration: const Duration(milliseconds: 500),
