class HireWokerHistoryResponseModel {
  List<HireWokers>? listHired;
  String? message;
  HireWokerHistoryResponseModel({this.listHired, this.message});
  factory HireWokerHistoryResponseModel.fromJson(List<dynamic> json) {
    return HireWokerHistoryResponseModel(
      listHired:
          json == [] ? [] : json.map((i) => HireWokers.fromJson(i)).toList(),
    );
  }
}
...
class HireWokers {
  ...
  factory HireWokers.fromJson(Map<String, dynamic> json) => HireWokers(
        id: json["id"],
